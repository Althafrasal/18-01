...
export declare type Channel = "SMS" | "Viber" | "RCS" | "Apple Messages for Business" | "WhatsApp" | "Telegram Messenger" | "Twitter" | "MobilePush" | "Facebook Messenger" | "Google Business Messages" | "Instagram";
...
export declare type WhatsAppInteractive = CMTypes.WhatsAppInteractive;
/**
...
export declare class Message extends CMTypes.MessageEnvelope {
   ...
   * @param template template definition and usage object
   */
    setInteractive(interactive: WhatsAppInteractive): Message;
    /**
